...
DEFAULT_MODELS = [
    ("ollama",    "llama3.2:latest",           20, 0.8),
    ("ollama",    "qwen2.5:7b",                20, 0.8),
    ("ollama",    "llama3.1:8b",               20, 0.8),
    ("ollama",    "mistral:latest",            20, 0.8),
]
...
def main():
    ...
    out_json = os.path.join(here, "attack_results_ollama_n20.json")
    out_md = os.path.join(here, "attack_results_ollama_n20.md")
    results = []
